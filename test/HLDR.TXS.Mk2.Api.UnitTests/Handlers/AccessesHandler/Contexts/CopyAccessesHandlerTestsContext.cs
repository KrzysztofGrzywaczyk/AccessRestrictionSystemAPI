...
public class CopyAccessesHandlerTestsContext : UnitTestsContextBase
{
    private readonly SqlDbContext _dbContext;

    public CopyAccessesHandlerTestsContext()
    {
        _dbContext = SqlDbContextFactory.Create();
        Handler = new CopyAccessesHandler(_dbContext);
    }

    public CopyAccessesHandler Handler { get; set; }
    ...
    public async Task SourceAccessesShouldStillExistInDatabase(AccessControlDevice targetDevice, AccessCard accessCard)
    {
