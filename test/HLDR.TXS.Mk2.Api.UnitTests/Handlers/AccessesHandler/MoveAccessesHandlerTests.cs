...
public class MoveAccessesHandlerTests : UnitTestsBase<MoveAccessesHandlerTestsContext>
{
    [Theory]
    [AutoSubstituteData]
    public async Task WhenSourceAccessesAndTargetAccessControlSystemExsists_ShouldMovedAccessesToTargetAccessControlSystem(string sourceDeviceId, string targetDeviceId, string accessCardValue)
    {
        // arrange
        var accessCard = new AccessCard() { Value = accessCardValue };

        var request = new MoveAccessesRequest() { SourceDeviceId = sourceDeviceId, TargetDeviceId = targetDeviceId };
        ...
        await Context.SourceAccessesShouldNotExistInDatabase(sourceDevice, accessCard);
    }
    ...
    public async Task WhenProvidedWrongSourceDevice_ShouldReturnNotFound(string sourceDeviceId, string targetDeviceId,  string wrongDeviceId, string accessCardValue)
    {
        ...
        var request = new MoveAccessesRequest() { SourceDeviceId = wrongDeviceId, TargetDeviceId = targetDeviceId };
        var sourceDevice = new AccessControlDevice()
        {
            DeviceName = sourceDeviceId,
            Description = $"Source-UnitTest-Device",
    ...
    public async Task WhenProvidedWrongTargetDevice_ShouldReturnNotFound(string sourceDeviceId, string targetDeviceId, string wrongDeviceId, string accessCardValue)
    {
        ...
        var request = new MoveAccessesRequest() { SourceDeviceId = sourceDeviceId, TargetDeviceId = wrongDeviceId };
        var sourceDevice = new AccessControlDevice()
        {
            DeviceName = sourceDeviceId,
            Description = $"Source-UnitTest-Device",
